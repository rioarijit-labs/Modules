...
3. **Look at `tests/`** for working usage before composing modules.
...
12. **Validate before you finish:** `python3 scripts/validate.py` must pass. It does not plan or apply; do not claim a module is deployed because it validates.
